...
class StreamSerializers private constructor() {
    // reason: `in`/`object` are escaped Kotlin keywords kept as the established Hazelcast
    // serializer parameter convention; called positionally everywhere, never as named args
    // reason: cohesive collection of stream (de)serialization helpers; splitting would fragment
    // the StreamSerializers utility surface used across all serializers
    @Suppress("FunctionParameterNaming", "TooManyFunctions")
    companion object {
