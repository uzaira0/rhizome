...
public class JettyConfiguration implements Configuration {
    ...
    protected static final String HARDENING_CONFIGURATION_PROPERTY        = "hardening";
    ...
    protected final HardeningConfiguration           hardeningConfiguration;
    ...
    public JettyConfiguration(
            ...
            @JsonProperty( HARDENING_CONFIGURATION_PROPERTY ) Optional<HardeningConfiguration> hardeningConfiguration ) {
        ...
        // Default to secure hardening configuration if not specified
        this.hardeningConfiguration = hardeningConfiguration.orElse( new HardeningConfiguration() );
    }
    ...
    @JsonProperty( HARDENING_CONFIGURATION_PROPERTY )
    public HardeningConfiguration getHardeningConfiguration() {
        return hardeningConfiguration;
    }
